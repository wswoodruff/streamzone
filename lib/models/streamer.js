...
module.exports = class Streamer extends Schwifty.Model {
    ...
    static get relationMappings() {
        ...
        const ProviderConnection = require('./provider-connection');
        ...
        return {
            ...
            providerConnections: { relation: Schwifty.Model.HasManyRelation, modelClass: ProviderConnection, join: { from: 'Streamer.id', to: 'ProviderConnection.streamerId' } }
        };
    }
};
