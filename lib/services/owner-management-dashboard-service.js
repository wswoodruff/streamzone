...
module.exports = class OwnerManagementDashboardService extends Schmervice.Service {
    ...
    team(authorization, actorRole, memberships, invitations, canManageMemberships) {
        const roleGuide = [
            ...
            { role: 'Editor', summary: 'Viewer access plus sources, streams, commands, rewards, and AI configuration/drafts.' },
    ...
    rewards(rewards, canManage) {
        ...
        return {
            ...
            architectureNote: 'AI is not a reward type. Reward fulfillment is limited to manual or deterministic bot execution.'
        };
    }
