...
// force-ssl covers both read-side live-chat ingestion and posting responses.
const YOUTUBE_SCOPES = ['openid', 'https://www.googleapis.com/auth/youtube.force-ssl'];
...
module.exports = class ProviderOAuthService extends Schmervice.Service {
    ...
    async completeConnection(code, state, actorUserId) {
        ...
        return this.server.services().youtubeProviderService.connect({ streamerId: record.streamerId, userId: actorUserId, accountId: claims.sub, scopes, tokens });
    }
