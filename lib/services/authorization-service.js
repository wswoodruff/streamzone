...
const capabilities = Object.freeze({
    owner: Object.freeze([
        ...
        'manageMemberships', 'manageRewards', 'fulfillRewards', 'editAiInstructions', 'publishAiInstructions', 'manageProviderConnections', 'deleteStreamer', 'transferOwnership'
    ]),
    admin: Object.freeze([
        'readManagement', 'manageSources', 'manageStreams', 'manageCommands', 'manageMemberships', 'manageRewards', 'fulfillRewards', 'editAiInstructions', 'publishAiInstructions', 'manageProviderConnections'
    ]),
    editor: Object.freeze(['readManagement', 'manageSources', 'manageStreams', 'manageCommands', 'manageRewards', 'fulfillRewards', 'editAiInstructions']),
    viewer: Object.freeze(['readManagement'])
});
const roleAuthority = Object.freeze({ viewer: 1, editor: 2, admin: 3, owner: 4 });
...
module.exports = class AuthorizationService extends Schmervice.Service {
    ...
    assertCanManageRole(actorRole, subjectRole) {
        ...
        if (subjectRole === 'owner') throw new AuthorizationError('Only an owner can manage owner memberships.');
        if (!roleAuthority[actorRole] || roleAuthority[subjectRole] >= roleAuthority[actorRole]) {
            throw new AuthorizationError('A role equal to or above your authority cannot be managed.');
        }
    }
...
module.exports.roleAuthority = roleAuthority;
